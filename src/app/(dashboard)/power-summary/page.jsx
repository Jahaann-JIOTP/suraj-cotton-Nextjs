  ...
  return (
    <div className="h-full lg:h-[81vh] overflow-y-auto">
      ...
      <div className="mt-3 md:mt-[0.9vw] flex flex-wrap items-center gap-3 lg:gap-[0.7vw] justify-between">
        ...
        <div className="w-full md:w-[23%] lg:w-[24.3%] ">
          <SingleValueDiv title="JMS" value={Number(powerSummaryData.JMS).toLocaleString("en-US")} unit="kWh" height="6rem" />
        </div>
      </div>
      {/* second section */}
      <div className="mt-3 md:mt-[0.9vw] flex flex-wrap items-center gap-3 lg:gap-[0.7vw] justify-between">
      ...
      <div className="mt-3 md:mt-[0.9vw]  flex flex-wrap items-center gap-3 lg:gap-[0.7vw] justify-between">
        ...
        <div className="w-full md:w-[23%] lg:w-[24.3%] ">
          <SingleValueDiv
            ...
            value={Number(powerSummaryData.HT_Transmissioin_Losses).toLocaleString("en-US")}
            unit="kWh"
            height="6rem"
            valueColor="#E40101"
          />
