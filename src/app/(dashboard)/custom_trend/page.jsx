...
function CustomTrend() {
  ...
  const parameterMapping = {
    "Del Active Energy  ": "Del_Active_Energy",
    " Current A    ": "Current_A",
    "Current B     ": "Current_B",
    "Current C     ": "Current_C",
  ...
  if (area === "Unit 4") {
    ...
    if (lt === "LT_1") {
      ...
      filteredMeters = [...lt1Meters, ...lt2Meters]; // Allow duplicates
    }
  }
  ...
  useEffect(() => {
    ...
    colorSet.list = [
      am4core.color("#00eaff"),
      am4core.color("#ff7b00"),
    ...
    selectedMeter.forEach((meter, i) => {
      ...
      series.name = `${meter} (${meterMapping[meter]})`; // Unique name with ID to distinguish duplicates
      series.stroke = colorSet.getIndex(i % colorSet.list.length);
  ...
  return (
    <div className="relative flex-shrink-0 w-full p-6 h-[81vh] bg-white dark:bg-gray-800 border-t-3 border-[#1F5897] rounded-[8px] shadow-md border-t-[#1d5999] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-6">
          ...
          <div ref={meterDropdownRef} className="relative">
            <label
              className="block text-sm font-medium text-gray-600 dark:text-gray-300 max-h-[100px] "
              style={{ color: "#1F5897" }}
            >
              Select Meters
            </label>
                      ...
                      <input
                        ...
                        onChange={() =>
                          setSelectedMeter((prev) =>
                            prev.includes(meter)
                              ? prev.filter((m) => m !== meter) // Fixed typo: m !== m to m !== meter
                              : [...prev, meter]
                          )
                        }
                        className="mr-2"
          ...
          <div ref={parameterDropdownRef} className="relative">
            ...
            <button
              ...
              className="w-full p-2 border rounded text-left bg-white dark:bg-gray-800 dark:text-gray-300"
            >
        ...
        <div id="chartDiv" className="h-[80%]">
          <style>
