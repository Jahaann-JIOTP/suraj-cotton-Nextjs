...
import React, { useState } from 'react'
 const getCardsDataFor =  [
    { title: "Ali", machines: 4, loadConnected: 0, consumption: 0, averagePower: 0, averagePowerFactor: 0, averageVoltage: 0, updatedAt: "2025-09-05" },
...
const U5Lt1Dailyconsumption = () => {
  ...
  return (
    <div className='bg-white shadow dark:bg-gray-800 rounded-md border-t-3 border-[#025697] overflow-y-auto h-full md:h-[81vh] px-4 py-3'>
        <div className=''>
            <DailyConsumptionPage pageTitle="Unit 5 - LT 1" data={getCardsDataFor}/>
        </div>
    </div>
  )
}

export default U5Lt1Dailyconsumption