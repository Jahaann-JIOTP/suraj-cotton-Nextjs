...
const TrendU5Lt2 = () => {
  ...
  const charts = [
    { id: "energy", title: "UNIT 5 LT 2 - ENERGY USAGE", Chart: EnergyChart },
    {
      id: "power",
      title: "UNIT 5 LT 2 - ACTIVE DEMAND (HISTORICAL)",
      Chart: PowerChart,
    },
    { id: "voltage", title: "UNIT 5 LT 2 - MAIN VOLTAGE", Chart: VoltageChart },
    { id: "current", title: "UNIT 5 LT 2 - MAIN CURRENT", Chart: CurrentChart },
    {
      id: "powerFactor",
      title: "UNIT 5 LT 2 - REACTIVE POWER AND PF",
      Chart: PowerFactorChart,
    },
    {
      id: "harmonics",
      title: "UNIT 5 LT 2 - VOLTAGE HARMONIC REDUCTION",
