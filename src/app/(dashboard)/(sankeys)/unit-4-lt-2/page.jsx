...
const UnitLt42Page = () => {
  const [Unit4Lt2TimePeriod, setUnit4Lt2TimePeriod] = useState("");
  const handleTimePeriodForUnit4Lt2 = (period) => {
    setUnit4Lt2TimePeriod(period);
  };
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-800 flex flex-col h-full p-4 rounded-md border-t-3 border-[#025697] ">
      <div className="w-full items-center flex justify-between">
        ...
        <TimePeriodSelector getTimePeriod={handleTimePeriodForUnit4Lt2} />
      </div>
