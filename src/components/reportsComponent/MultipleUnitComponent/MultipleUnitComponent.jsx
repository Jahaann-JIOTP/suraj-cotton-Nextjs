...
const MultipleUnitComponent = ({
  ...
  const tableData = [
    ...
    },
    {
      ...
      u4Load: "19+6.6",
      u5Load: "",
      u4Consumption: data.unit_4Card_Breaker_consumption,
      u5Consumption: data.unit_5Card_Breaker_consumption,
      u4andU5TotalConsumption: u4U5Total.card_breaker,
      unit: "Unit_4",
    },
    {
      dept: "Card",
    ...
    },
    {
      ...
      u4Load: "6.2+11.8",
      u5Load: "19.9+13.2",
      u4Consumption: data.unit_4Comberandunilap_consumption,
      u5Consumption: data.unit_5Comberandunilap_consumption,
      u4andU5TotalConsumption: u4U5Total.comberandunilap,
      unit: "both",
    },
    {
      ...
      u4andU5TotalConsumption: u4U5Total.drawingfinisherand2breaker,
      unit: "Unit_4",
    },
    {
      ...
      u5Consumption: data.unit_5DrawingFinisher1to8Breaker_consumption,
      u4andU5TotalConsumption: u4U5Total.drawingfinisher1to8breaker,
      unit: "Unit_5",
    },
    {
    ...
    {
      dept: "Drawing Simplex",
      u4Mcs: "6",
      u5Mcs: "",
      u4Load: "16.5",
      u5Load: "",
      u4Consumption: data.unit_4DrawingSimplex_consumption,
      u5Consumption: data.unit_5DrawingSimplex_consumption,
      u4andU5TotalConsumption: u4U5Total.drawingsimplex,
      unit: "Unit_4",
    },
    {
    ...
    {
      dept: "Auto Cone (Winding) 10-18",
      u4Mcs: "9",
      u5Mcs: "18",
      u4Load: "30",
      u5Load: "26.2",
      u4Consumption: data.unit_4AutoCone_Winding10to18_consumption,
      u5Consumption: data.unit_5AutoCone_Winding10to18_consumption,
      u4andU5TotalConsumption: u4U5Total.autocone_winding10to18,
      unit: "both",
    },
    {
      dept: "B/Card + Comber Filter",
      u4Mcs: "",
      u5Mcs: "",
      u4Load: "199",
      u5Load: "267.7",
      u4Consumption: data.unit_4B_CardandComberFilter_consumption,
      u5Consumption: data.unit_5B_CardandComberFilter_consumption,
      u4andU5TotalConsumption: u4U5Total.b_cardandcomberfilter,
      unit: "both",
    },
    {
      dept: "A/C Back Process",
      u4Mcs: "",
      u5Mcs: "",
      u4Load: "138",
      u5Load: "245.4",
      u4Consumption: data.unit_4AC_BackProcess_consumption,
      u5Consumption: data.unit_5AC_BackProcess_consumption,
      u4andU5TotalConsumption: u4U5Total.ac_backprocess,
      unit: "both",
    },
    {
      dept: "A/C Ring",
      ...
      u4andU5TotalConsumption: u4U5Total.ac_ring,
      unit: "both",
    },
    {
      dept: "A/C Auto cone(Winding)",
      u4Mcs: "",
      u5Mcs: "",
      u4Load: "71",
      u5Load: "100.5  ",
      u4Consumption: data.unit_4AC_AutoCone_Winding_consumption,
      u5Consumption: data.unit_5AC_AutoCone_Winding_consumption,
      u4andU5TotalConsumption: u4U5Total.ac_autocone_winding,
      unit: "both",
    },
    {
      dept: "Air Compressor",
    ...
    },
    {
      ...
      u4Load: "22",
      u5Load: "22",
      u4Consumption: data.unit_4Deep_Well_Turbine_consumption,
      u5Consumption: data.unit_5Deep_Well_Turbine_consumption,
      u4andU5TotalConsumption: u4U5Total.deep_well_turbine,
      unit: "both",
    },
    {
      dept: "Bailing Press",
    ...
    },
    {
      ...
      u4Load: "60",
      u5Load: "60",
      u4Consumption: data.unit_4Mills_Lighting_consumption,
      u5Consumption: data.unit_5Mills_Lighting_consumption,
      u4andU5TotalConsumption: u4U5Total.mills_lighting,
      unit: "both",
    },
    {
    ...
    {
      dept: "Conditioning Machine",
      u4Mcs: "1",
      u5Mcs: "1",
      u4Load: "72",
      u5Load: "72",
      u4Consumption: data.unit_4Conditioning_Machine_consumption,
      u5Consumption: data.unit_5Conditioning_Machine_consumption,
      u4andU5TotalConsumption: u4U5Total.conditioning_machine,
      unit: "both",
    },
    {
      dept: "Workshop",
      ...
      u4Load: "",
      u5Load: "",
      u4Consumption: data.unit_4Workshop_consumption,
      u5Consumption: data.unit_5Workshop_consumption,
      u4andU5TotalConsumption: u4U5Total.workshop,
      unit: "Unit_4",
    },
    {
      dept: "Lab + Offices",
      ...
      u4Load: "",
      u5Load: "",
      u4Consumption: data.unit_4Lab_and_Offices_consumption,
      u5Consumption: data.unit_5Lab_and_Offices_consumption,
      u4andU5TotalConsumption: u4U5Total.lab_and_offices,
      unit: "Unit_4",
    },
    {
      dept: "Power House Gas",
      u4Mcs: "",
      u5Mcs: "",
      u4Load: "",
      u5Load: "",
      u4Consumption: data.unit_4Power_House2ndSourceGas_consumption,
      u5Consumption: data.unit_5Power_House2ndSourceGas_consumption,
      u4andU5TotalConsumption: u4U5Total.power_house2ndsourcegas,
      unit: "Unit_4",
    },
    {
      dept: "Power House HFO",
      u4Mcs: "",
      u5Mcs: "",
      u4Load: "",
      u5Load: "",
      u4Consumption: data.unit_4Power_House2ndSourceHFO_consumption,
      u5Consumption: data.unit_5Power_House2ndSourceHFO_consumption,
      u4andU5TotalConsumption: u4U5Total.power_house2ndsourcehfo,
      unit: "Unit_4",
    },
    {
      dept: "Water Chiller",
  ...
  const exportEnergyReportToExcel = async () => {
    try {
      ...
      const mainHeadingCell = worksheet.getCell(`A${currentRowIndex}`);
