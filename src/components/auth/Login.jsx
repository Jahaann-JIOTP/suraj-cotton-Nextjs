    ...
    >
      <div className="w-[420px] border border-white/30 backdrop-blur-[15px] shadow-[0_0_10px_rgba(255,255,255,0.2)] text-black p-[30px] px-[40px] rounded-[20px] transition-all duration-300 ease-in-out">
        <div className="flex justify-center mb-6">
          <img src="/suraj-cotton-login-logo.png" alt="Logo" className="w-[140px]" />
        </div>
        <h2 className="text-3xl font-semibold text-center text-white mb-4">Login</h2>
        ...
        {success && (
          <div className="flex items-center justify-center text-green-700 bg-green-100 border border-green-300 rounded-md mt-4 p-3 transition-all duration-300 animate-fadeIn">
            <svg className="w-5 h-5 mr-2 text-green-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 00-1.414 0L8 12.586l-3.293-3.293a1 1 0 10-1.414 1.414l4 4a1 1 0 001.414 0l8-8a1 1 0 000-1.414z" clipRule="evenodd"></path>
            </svg>
            <span>{success}</span>
          </div>
        )}
        {error && (
          <div className="flex items-center justify-center text-red-700 bg-red-100 border border-red-300 rounded-md mt-4 p-3 transition-all duration-300 animate-fadeIn">
            <svg className="w-5 h-5 mr-2 text-red-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" d="M8.257 3.099c.366-.446.962-.506 1.414 0l6 7a1 1 0 01-1.414 1.414L10 6.414 5.743 11.513a1 1 0 01-1.414-1.414l6-7z" clipRule="evenodd"></path>
              <path fillRule="evenodd" d="M10 18a1 1 0 01-.707-.293l-6-6a1 1 0 011.414-1.414L10 15.586l5.293-5.293a1 1 0 111.414 1.414l-6 6A1 1 0 0110 18z" clipRule="evenodd"></path>
            </svg>
            <span>{error}</span>
          </div>
        )}
