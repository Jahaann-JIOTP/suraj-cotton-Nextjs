          ...
          .map((privilegeKey) => {
            ...
            return (
              <div key={privilegeKey} className="">
                <button
                  className="w-full flex justify-between items-center font-bold py-2 px-3 hover:bg-gray-100 rounded-md"
                        ...
                        {item.submenu ? (
                          <div>
                            <button
                              ...
                              className="w-full flex justify-between items-center py-2 px-2 text-sm hover:bg-gray-100 rounded-md"
                            >
